...
class ModelConfig(BaseModel):
    ...
    model_path: Path = Paths().MODELS / "combined_xgb_final_model.pkl"
    scaler_path: Path = Paths().MODELS / "combined_scaler.pkl"
    feature_names_path: Path = Paths().MODELS / "combined_feature_names.json"

    categorical_features: List[str] = [
        "higher_yes", "schoolsup_yes", "romantic_yes", "paid_yes", "guardian_mother", "guardian_other",
